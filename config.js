...
module.exports = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '★彡[ᴍʀ. ꜱɪᴛʜᴜᴍ]彡★;༺ֆքʟɛӼ ʀօɮօȶ༻;https://www.linkpicture.com/q/splex-robot.png' : process.env.AUDIO_DATA,
    TAKE_KEY: process.env.TAKE_KEY || '',
    MODE: process.env.MODE || 'public',
    WARN: process.env.WARN || '4',
    ANTILINK_WARN: process.env.ANTILINK_WARN || '❗ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛᴇᴅ❗',
    HEROKU: {
